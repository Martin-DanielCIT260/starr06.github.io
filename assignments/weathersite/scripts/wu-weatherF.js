...
weatherObject.open('GET', '//api.wunderground.com/api/cb37f191fa75ceaa/conditions/q/MN/Franklin.json', true );
...
weatherForecast.open('GET', '://api.wunderground.com/api/cb37f191fa75ceaa/forecast/q/MN/Franklin.json', true );
