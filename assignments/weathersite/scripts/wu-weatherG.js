...
weatherObject.open('GET', '//api.wunderground.com/api/cb37f191fa75ceaa/conditions/q/IL/Greenville.json', true );
...
weatherForecast.open('GET', '//api.wunderground.com/api/cb37f191fa75ceaa/forecast/q/IL/Greenville.json', true );
